...
export const TopStageBar: React.FC<{
    ...
    selectedRemote
        ...
        <div className="flex items-center justify-between gap-2 mb-4 w-full px-1 flex-wrap">
            <div className="flex items-center gap-2 mb-1 flex-shrink-0 w-[100%]">
                <GitBranch size={18} className="text-purple-400 w-fit" />
                <select
                    className="bg-gray-800 border border-gray-700 rounded-lg text-gray-100 px-2 py-1 min-w-[50px] outline-none focus:ring-2 focus:ring-blue-500"
